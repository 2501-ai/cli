...
export const getFunctionName = (
  ...
  if (typeof action.function === 'object') {
    Logger.warn('getFunctionName action.function should be a string');
  }
  return typeof action.function === 'object'
...
export const getFunctionArgs = (action: FunctionAction) => {
  ...
  if (typeof action.function !== 'string') {
    Logger.warn('getFunctionArgs action.function should be a string!', action);
    args = (action.function as any).arguments;
